                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><center>
                                    <button class="btn btn-icon waves-effect waves-light btn-warning editButton" data-toggle="modal" data-target="#ubahpaketumroh" data-id="<?= $value->id_paket ?>"> <i class="glyphicon glyphicon-pencil"></i> </button>
                                    |
                                    <a href="<?=base_url('PaketUmrohController/hapus_data/'.$value->id_paket);?>" onclick="return confirm('Anda Yakin Menghapus Data?')"><button class="btn btn-icon waves-effect waves-light btn-danger"> <i class="glyphicon glyphicon-trash"></i> </button></a></center>
                                </td>
                            </tr>
                            <?php
                            }
...
<div id="tambahpaketumroh" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form"  action="<?=base_url('PaketUmrohController/tambah_data');?>" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
...
<div id="ubahpaketumroh" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form"  action="<?=base_url('PaketUmrohController/edit_data');?>" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
            <div class="modal-body">
                <div class="form-group">
                    <label  class="col-sm-4 control-label">Program</label>
                    <div class="col-sm-7">
...
<script type="text/javascript">
    window.onload = function(){
        $('.editButton').on('click', function(){
            ...
            $.ajax({
                url : "<?= base_url('PaketUmrohController/edit') ?>",
