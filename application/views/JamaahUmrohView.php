    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="card-box">
                    <a href="<?=base_url('PendaftaranUmrohController/daftarJamaah/'.$id_paket);?>" ><button type="button" class="btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#daftarbaru"><i class="fa fa-plus m-r-5"></i> <span> Daftar Baru </span></button></a>
                        <br><br>
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><center><a href="<?=base_url('PendaftaranUmrohController/hapus/'.$value->id_daftar_jamaah);?>" onclick="return confirm('Anda Yakin Menghapus Data?')"><button class="btn btn-icon waves-effect waves-light btn-danger"> <i class="glyphicon glyphicon-remove"></i> </button></a></center>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
