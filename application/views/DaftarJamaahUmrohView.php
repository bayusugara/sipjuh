    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        <h4 class="page-title"><b>Daftar Baru Jamaah Umroh</b></h4>
                        <hr>

                        <form class="form-horizontal" role="form" action="<?=base_url('PendaftaranUmrohController/tambah_data/'.$id_paket);?>" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
