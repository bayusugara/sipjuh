                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><center><button class="btn btn-icon waves-effect waves-light btn-warning" data-toggle="modal" data-target="#ubahpakethaji"> <i class="glyphicon glyphicon-pencil"></i> </button>|<a href="#" onclick="return confirm('Anda Yakin Menghapus Data?')"><button class="btn btn-icon waves-effect waves-light btn-danger"> <i class="glyphicon glyphicon-trash"></i> </button></a></center>
                                </td>
                            </tr>
                        </tbody>
                    </table>
